...
namespace Flight_System {
    ...
    public partial class TESTDataSet : global::System.Data.DataSet {
        ...
        public partial class AIRPORTDataTable : global::System.Data.TypedTableBase<AIRPORTRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public AIRPORTRow AddAIRPORTRow(string ID, string NAME, string CITY, string COUNTRY) {
        ...
        public partial class TICKETDataTable : global::System.Data.TypedTableBase<TICKETRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public TICKETRow AddTICKETRow(string ID, FLIGHTRow parentFLIGHTRowByFK_TICKET_RESERVE_FLIGHT, string CLASS, int PRICE) {
                ...
                if ((parentFLIGHTRowByFK_TICKET_RESERVE_FLIGHT != null)) {
                    columnValuesArray[1] = parentFLIGHTRowByFK_TICKET_RESERVE_FLIGHT[0];
                }
...
SELECT ID, TYPE, MODEL, CAPACITY FROM AIRCRAFT WHERE (ID = @ID)";
    ...
    public partial class AIRPORTTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [AIRPORT] WHERE (([ID] = @Original_ID) AND ((@IsNull_NAME = 1 AND [NAME] IS NULL) OR ([NAME] = @Original_NAME)) AND ((@IsNull_CITY = 1 AND [CITY] IS NULL) OR ([CITY] = @Original_CITY)) AND ((@IsNull_COUNTRY = 1 AND [COUNTRY] IS NULL) OR ([COUNTRY] = @Original_COUNTRY)))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [AIRPORT] ([NAME], [CITY], [COUNTRY]) VALUES (@NAME, @CITY, @COUNTRY)" +
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [AIRPORT] SET [NAME] = @NAME, [CITY] = @CITY, [COUNTRY] = @COUNTRY WHERE (([ID] = @Original_ID) AND ((@IsNull_NAME = 1 AND [NAME] IS NULL) OR ([NAME] = @Original_NAME)) AND ((@IsNull_CITY = 1 AND [CITY] IS NULL) OR ([CITY] = @Original_CITY)) AND ((@IsNull_COUNTRY = 1 AND [COUNTRY] IS NULL) OR ([COUNTRY] = @Original_COUNTRY)));
SELECT ID, NAME, CITY, COUNTRY FROM AIRPORT WHERE (ID = @ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT ID, NAME, CITY, COUNTRY FROM AIRPORT";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
...
SELECT TICKET_ID, USER_ID FROM RESERVATION WHERE (TICKET_ID = @TICKET_ID) AND (USER_ID = @USER_ID)";
    ...
    public partial class TICKETTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [TICKET] WHERE (([ID] = @Original_ID) AND ((@IsNull_FLIGHT_ID = 1 AND [FLIGHT_ID] IS NULL) OR ([FLIGHT_ID] = @Original_FLIGHT_ID)) AND ((@IsNull_CLASS = 1 AND [CLASS] IS NULL) OR ([CLASS] = @Original_CLASS)) AND ((@IsNull_PRICE = 1 AND [PRICE] IS NULL) OR ([PRICE] = @Original_PRICE)))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_ID", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "ID", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [TICKET] ([ID], [FLIGHT_ID], [CLASS], [PRICE]) VALUES (@ID, @FLIGHT_I" +
                "D, @CLASS, @PRICE);\r\nSELECT ID, FLIGHT_ID, CLASS, PRICE FROM TICKET WHERE (ID = " +
                "@ID)";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [TICKET] SET [ID] = @ID, [FLIGHT_ID] = @FLIGHT_ID, [CLASS] = @CLASS, [PRICE] = @PRICE WHERE (([ID] = @Original_ID) AND ((@IsNull_FLIGHT_ID = 1 AND [FLIGHT_ID] IS NULL) OR ([FLIGHT_ID] = @Original_FLIGHT_ID)) AND ((@IsNull_CLASS = 1 AND [CLASS] IS NULL) OR ([CLASS] = @Original_CLASS)) AND ((@IsNull_PRICE = 1 AND [PRICE] IS NULL) OR ([PRICE] = @Original_PRICE)));
SELECT ID, FLIGHT_ID, CLASS, PRICE FROM TICKET WHERE (ID = @ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT ID, FLIGHT_ID, CLASS, PRICE FROM TICKET";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
